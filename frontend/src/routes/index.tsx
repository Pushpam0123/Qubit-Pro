        ...
        <div className="relative z-10 grid grid-cols-1 gap-10 px-6 pb-28 pt-8 lg:grid-cols-[1.05fr_1fr] lg:gap-14 lg:px-10 lg:pt-12">
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              {/* ── CHANGED: was <Link to="/designer">, now fires coming-soon alert ── */}
              <Button
                onClick={() => alert("🚧 Coming soon!")}
                className="h-12 rounded-full bg-foreground px-6 text-sm font-semibold text-background opacity-50 cursor-not-allowed hover:bg-foreground"
              >
                Start designing
              </Button>
              <a
    ...
    >
      <div className="flex items-center justify-between px-6 py-4 lg:px-10">
        ...
        <div className="flex items-center gap-2">
          {user ? (
            <>
              {/* ── CHANGED: was asChild + <Link to="/dashboard">, now fires coming-soon alert ── */}
              <Button
                variant="ghost"
                onClick={() => alert("🚧 Coming soon!")}
                className="h-9 rounded-full px-4 text-sm text-foreground opacity-50 cursor-not-allowed hover:bg-transparent"
              >
                Dashboard
              </Button>
              {/* ── CHANGED: was asChild + <Link to="/designer">, now fires coming-soon alert ── */}
              <Button
                onClick={() => alert("🚧 Coming soon!")}
                className="h-9 rounded-full bg-foreground px-4 text-sm font-semibold text-background opacity-50 cursor-not-allowed hover:bg-foreground"
              >
                Open designer
              </Button>
            </>
